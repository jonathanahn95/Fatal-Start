...
class Game {
  ...
  initialSetup() {
    ...
    this.addCharacters();
    this.players.push(new _player__WEBPACK_IMPORTED_MODULE_3__["default"]( {pos: [100, 450], game: this, ctx: this.ctx} ));
    // this.addBullets();
  }

  addCharacters() {
    for (var i = 0; i < this.NUM_CHAR; i++) {
      this.add(new _character__WEBPACK_IMPORTED_MODULE_2__["default"]( { pos: Object(_util__WEBPACK_IMPORTED_MODULE_0__["randomPosition"])(this.width, this.height), game: this }) );
    }
  }
...
/*!*********************!*\
  !*** ./lib/util.js ***!
  \*********************/
/*! exports provided: randomVec, test, scale, dir, norm, randomPosition, wrap, dist */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
