...
class Goku extends MovingObject {
  ...
  draw() {
    ...
    this.ctx.drawImage(this.image, this.sX , 0, 800, 800, this.pos[0] - 50, this.pos[1] -40 , 700, 700);
  ...
  collideWith(otherObj) {
    ...
    if (otherObj instanceof EnemyBullet || otherObj instanceof KrillinBullet || otherObj instanceof FreizaBullet){
      this.lives-= 1;
